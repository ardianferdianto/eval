						...
						<div class="content_tryout_container">
							...
							<div class="wizard wizardtryout" id="wizard">
							        		...
							        		<div class="grid">
											    <div class="row">
											        <div class="span6 offset1">
											        	<legend>LANGKAH PERTAMA<br/><small>Berikan nama untuk <?php
									switch ($tipesoalID) {
									 	case '1':
									 		echo 'Tryout';
									 		break;
								...
								?></small></legend>
											 			<div class="input-control text">
															<?php echo $form->input('kode',array('label'=>false,'class'=>'text-input large-input','id'=>'txt_kode_soal','placeholder'=>'Tuliskan kode soal, contoh : soal_ujian_pertama'));?>
														</div>
											        </div>
											    </div>
											</div>
							        ...
							        <div class="step">
											...
											<?php else:?>
											    ...
											    <div class="tryout_info_selected_soal" style="margin-top:10px;margin-bottom:20px;">
											    	<legend>LANGKAH KEDUA<br/><small>Pilih soal soal yang ingin anda masukkan</small></legend>
							...
							*/
							        ...
							        <div class="step" id="step3">
							        	<legend>LANGKAH KETIGA<br/><small>Urutkan Soal, dan tentukan waktu</small></legend>
